...
fun CoinListItem(
    ...
    Row(
        ...
        Icon(
            imageVector = ImageVector.vectorResource(id = coinsUi.iconRes),
            contentDescription = coinsUi.name,
        ...
        Column(
            ...
            Text(
                text = "$ ${coinsUi.priceUsd.formatted}",
                fontSize = 16.sp,
            ...
            PriceChange(
                change = coinsUi.changePercent24Hr
            )
        }
    }
}
